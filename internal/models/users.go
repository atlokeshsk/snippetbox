...
func (m *UserModel) Insert(name, email, password string) error {
	...
	if err != nil {
		...
		// checking if the error code equals 1062 and the contents of the error // message string. If it does, we return an ErrDuplicateEmail error. var mySQLError *mysql.MySQLError
